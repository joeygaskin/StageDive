...
var {
    ...
    var JAYZandBeyonce = React.createClass({
      jumpBack: function() {
      ...
      render: function() {
        ...
        source={{uri: 'https://s3.amazonaws.com/vice_asset_uploader/files/1405182922beyonce_jay_z_on_the_run.png'}}>
        <Image style={{ position: 'absolute', top: 80, left: 30, width: 125, height: 125, borderWidth: 1, borderColor: '#ccc'}}
        source={{uri: 'http://static.parkwoodent.netdna-cdn.com/wp-content/uploads/2014/09/OTR-Poster.jpg'}}/>
        <TouchableOpacity
        ...
        color: '#fff',
        fontWeight: 'bold',
        fontSize: 18}}>JAY-Z & Beyoncé</Text>
        </View>
        ...
        color: '#fff',
        fontWeight: 'bold',
        fontSize: 14}}>On The Run Tour</Text></View>
        ...
        <View style={{marginBottom: 250}}>
          ...
          <Text style={{fontWeight: 'bold'}}>The On the Run Tour</Text> was the co-headlining stadium tour by <Text style={{fontWeight: 'bold'}}>Beyoncé</Text> and <Text style={{fontWeight: 'bold'}}>JAY-Z</Text>.
           The joint tour came shortly after the two had finished their own solo tours: Beyoncé's <Text style={{fontWeight: 'bold'}}>The Mrs. Carter Show World Tour </Text>
            and JAY-Z's <Text style={{fontWeight: 'bold'}}>Magna Carter World Tour</Text>. The tour name spins off from the duo's song <Text style={{fontStyle: 'italic'}}>"Part II (On the Run)"</Text>, included
             on Jay-Z's album <Text style={{fontWeight: 'bold'}}>Magna Carta Holy Grail</Text>.
          </Text>
          ...
          <Text style={{color:'#333', fontWeight: 'bold', fontSize: 10}}>(click box to play or pause)</Text>
            ...
            <TouchableOpacity style={styles.outerfullScreen} onPress={() => {this.setState({paused: !this.state.paused})}}>
              <Video source={{uri: "https://github.com/joeygaskin/StageDive/raw/master/otrvideo.mp4"}}
